...
The corresponding \sys-minus-\sys-Raw intervals are [-.0003,.0029], [-.0116,.0103], and [-.0247,.0280], all spanning zero.
% 结果。Direct+\sys 相对 Direct-only 分别提高 .031 [.024,.039]、.107 [.093,.120] 与 .117 [.088,.148]（10,000 次配对重抽样的 95\% 区间）；所有区间位于零以上，因此每项改进在统计上显著。对应的 \sys-\sys-Raw 区间均跨越零。
...
A profile-guided variant uses the semantic skeleton to select at most five groups and opens only their evidence.
% profile 引导变体用语义骨架选择最多五个 group，并只打开其 evidence。
