...
27{,}765 operations.
% 各 workload 平均每条轨迹的 operation 数分别为 AgentProcessBench 8.5、OSWorld-Human 13.9、HINTBench 24.0、TraceElephant 27.1、CodeTraceBench 51.5，因此 benchmark 轨迹属于短到中长度，而被标注的 42-session 工作站部分（最长 session 跨越数十小时）提供长 horizon 覆盖；RQ4 的并集覆盖 27,765 个 operation。
